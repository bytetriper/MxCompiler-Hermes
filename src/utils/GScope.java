...
public class GScope extends Scope{
    public void init(){
        ...
        n1.paras.add(new SingleAssignNode(new TypeNode("int")));
        malloc1.type=new TypeNode("int",1);
        malloc1.paras.add(new SingleAssignNode(new TypeNode("int")));
        get2.type=new TypeNode("int");
        /* 
